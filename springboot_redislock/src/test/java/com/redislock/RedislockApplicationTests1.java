...
@SpringBootTest
public class RedislockApplicationTests1 {

    private static  final Logger log= LoggerFactory.getLogger(RedislockApplicationTests1.class);
    @Autowired(required = false)
    RedisLockSetNX2 redisLockSetNX2;
    ...
    class Service implements  Runnable{
        ...
        public void run() {
            ...
            boolean lock=redisLockSetNX2.getLock("lock1",uuid,4);
            if(lock){
                try {
                    ...
                    redisLockSetNX2.deleteLock("lock1",uuid);
                }
            }else {
                //获取锁失败，持续竞争，下一秒竞争
